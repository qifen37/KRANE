...
class Main(object):
	...
	def load_data(self):
		...
		for split in ['train', 'valid','test']:
			for line in open('/root/Biokg/data/{}/{}.tsv'.format(self.p.dataset, split)):
...
if __name__ == "__main__":
	...
	parser.add_argument('-epoch',		dest='max_epochs', 	default=400,		type=int,  		help='Maximum number of epochs')
	parser.add_argument('-num_workers',	type=int,               default=30,                      		help='Maximum number of workers used in DataLoader')
	parser.add_argument('-seed',           dest='seed',            default=1234,   		type=int,       	help='Seed to reproduce results')
	parser.add_argument('-restore',   	dest='restore',       	action='store_true',            		help='Restore from the previously saved model')
	parser.add_argument('-opn',             dest='opn',             default='corr',                 help='Composition Operation to be used in CompGCN')
	parser.add_argument("--op", type=str, default="rotate", help="aggregation opration")
	...
	# Logging parameters
	parser.add_argument('-logdir',    	dest='log_dir',       	default='/root/Biokg/code/log/',               		help='Log directory')
	parser.add_argument('-config',    	dest='config_dir',    	default='/root/Biokg/code/config/',            		help='Config directory')
